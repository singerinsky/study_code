...
void test_void_call() { return function_template(1.0f); }
...
template <typename T> void function_(T &t) { LOG(INFO) << t + 1; }
...
template <> void do_fill<1>(std::vector<int> &vec) { vec.push_back(0); }
